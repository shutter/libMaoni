...
bool stla_check (const char *input_file_name )
...
bool stla_read ( const char *input_file_name, int node_num, int face_num,
...
void stla_size ( const char *input_file_name, int *solid_num, int *node_num,
...
//  Parameters:
//
//    Input, character *INPUT_FILE_NAME, the name of the input file.
//
...
void stla_size_print ( const char *input_file_name, int solid_num, int node_num,
  int face_num, int text_num )
...
//  Parameters:
//
//    Input, char *INPUT_FILE_NAME, the name of the input file, or the
//    name of the object.
//
...
void stla_write ( char *output_file_name, int node_num, int face_num, 
...
//  Parameters:
//
//    Input, char *OUTPUT_FILE_NAME, the name of the output file.
//
//    Input, int NODE_NUM, the number of nodes.
//
//    Input, int FACE_NUM, the number of faces.
...
char *word_next_read ( char *s, bool *done )
...
//  Parameters:
//
//    Input, char *S, a string, presumably containing words
//    separated by spaces.
//
...
//
//    Output, character ( len = * ) WORD_NEXT_READ.
